  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-indigo-200/60 via-white to-orange-tertiary px-[20%]">
      <div className="w-full max-w-lg bg-[#FFFFFF8C] backdrop-blur-xl shadow-xl rounded-2xl px-12 py-12 text-center">
        ...
        {/* Heading */}
        <div className="mb-6">
          <h2 className="text-3xl font-bold text-black-primary">Enter Your Code</h2>
        ...
        <div className="flex justify-center gap-4 mb-6">
          {code.map((digit, idx) => (
            <input
              ...
              className="w-14 h-14 text-black-primary text-center border border-gray-secondary rounded-full text-2xl font-bold focus:border-orange-primary outline-none"
            />
          ))}
        </div>
        ...
        <p className="text-sm text-gray-primary mb-6">
          Didn&apos;t get the code?{" "}
          <button className="text-orange-primary font-medium cursor-pointer hover:underline">
            Resend
          </button>
        </p>
        ...
        <Link
          ...
          className="w-full block text-center border border-gray-secondary bg-white text-black-primary font-medium py-3 rounded-full mt-3 hover:bg-gray-50 transition"
        >
          Back
        </Link>
      </div>
